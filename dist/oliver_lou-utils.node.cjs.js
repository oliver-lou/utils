...
class SortedLinkedList extends LinkedList {
    ...
    getIndexNextSortedElement(element) {
        ...
        for (; i < this.size() && current; i++) {
            ...
            if (comp === exports.Compare.LESS_THAN) {
                return i;
            }
            current = current.next;
        }
...
class BinarySearchTree {
    ...
    insertNode(node, value) {
        if (this.compareFn(value, node.value) === exports.Compare.LESS_THAN) {
            if (node.left == null) {
    ...
    searchNode(node, value) {
        ...
        else if (this.compareFn(value, node.value) === exports.Compare.BIGGER_THAN) {
...
exports.checkIpOrDomain = checkIpOrDomain;
exports.checkMAC = checkMAC;
exports.checkNames = checkNames;
exports.checkPhone = checkPhone;
exports.checkPostbox = checkPostbox;
exports.checkRangeInt = checkRangeInt;
exports.checkSingleIp = checkSingleIp;
exports.curry = curry;
exports.debounce = debounce;
exports.deepClone = deepClone;
exports.deepCloneByMessageChannel = deepCloneByMessageChannel;
exports.defaultCompare = defaultCompare;
exports.defaultEquals = defaultEquals;
exports.formatAccount = formatAccount;
exports.generateNumberList = generateNumberList;
exports.getDataTypeof = getDataTypeof;
...
exports.isNarrowObject = isNarrowObject;
...
exports.isTrainOrderTicketTime = isTrainOrderTicketTime;
exports.isValidDate = isValidDate;
exports.jointClassName = jointClassName;
exports.localeCompare = localeCompare;
exports.log = log;
exports.makeMap = makeMap;
exports.objectToParams = objectToParams;
exports.removeNullString = removeNullString;
exports.shuffleArray = shuffleArray;
exports.sliceByPoint = sliceByPoint;
exports.splitText = splitText;
exports.throttle = throttle;
exports.transform16To10 = transform16To10;
exports.transformRGBColorToMatlabColor = transformRGBColorToMatlabColor;
exports.transformToAmountInWords = transformToAmountInWords;
exports.trim = trim;
